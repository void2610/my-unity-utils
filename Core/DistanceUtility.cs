...
public static class DistanceUtility
{
    ...
    public static int GetManhattanDistance(Vector2Int pos1, Vector2Int pos2) => Mathf.Abs(pos1.x - pos2.x) + Mathf.Abs(pos1.y - pos2.y);
    ...
    public static int GetChebyshevDistance(Vector2Int pos1, Vector2Int pos2) => Mathf.Max(Mathf.Abs(pos1.x - pos2.x), Mathf.Abs(pos1.y - pos2.y));
